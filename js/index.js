...
document.addEventListener('DOMContentLoaded', function () {
  ...
  const btnSortComplete = document.querySelector(
    '.footer__box--elements-mid--3'
  );
  const allTodosButton = document.querySelector(
    '.footer__box--elements-mid--1'
  );
  ...
  const renderTodos = function (e, i) {
    ...
    todoArr.forEach(element => {
      ...
      <span id="clear" class="layouts__radio-clear hidden">
        <img src="/icon-cross.4105108f.svg" class="icons-clear" />
      </span>
    </div>
